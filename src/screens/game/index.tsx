  ...
  if (!gameStarted)
    return (
      <View style={styles.newGameScreen}>
        <TouchableOpacity style={{backgroundColor: 'purple', paddingHorizontal: 25, paddingVertical: 10, borderRadius: 5}} onPress={resetGame}>
          <Text style={{ color: 'white', fontSize: 20 }}>Start a new game</Text>
        </TouchableOpacity>
        <Text style={{ color: 'white', fontSize: 14, marginTop: 25 }}>Created by Vishal Tiwari for eLitmus Evaluation</Text>
        <Text style={{color: 'white', fontSize: 14}}>eLitmus ID - 4814989</Text>
      </View>
    );
  return (
